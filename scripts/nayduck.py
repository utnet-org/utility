...
Scheduled runs can be seen at <https://nayduck.unc.org/>.
...
organisation on GitHub to authenticate (<https://github.com/orgs/unc/people>).

The source code for NayDuck itself is at <https://github.com/unc/nayduck>.
"""
