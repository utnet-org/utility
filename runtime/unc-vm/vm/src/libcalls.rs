...
#[no_mangle]
pub extern "C" fn unc_vm_f32_ceil(x: f32) -> f32 {
    x.ceil()
}

/// Implementation of f32.floor
#[no_mangle]
pub extern "C" fn unc_vm_f32_floor(x: f32) -> f32 {
    x.floor()
}

/// Implementation of f32.trunc
#[no_mangle]
pub extern "C" fn unc_vm_f32_trunc(x: f32) -> f32 {
    x.trunc()
}
...
#[no_mangle]
pub extern "C" fn unc_vm_f32_nearest(x: f32) -> f32 {
...
#[no_mangle]
pub extern "C" fn unc_vm_f64_ceil(x: f64) -> f64 {
    x.ceil()
}

/// Implementation of f64.floor
#[no_mangle]
pub extern "C" fn unc_vm_f64_floor(x: f64) -> f64 {
    x.floor()
}

/// Implementation of f64.trunc
#[no_mangle]
pub extern "C" fn unc_vm_f64_trunc(x: f64) -> f64 {
    x.trunc()
}
...
#[allow(clippy::float_arithmetic, clippy::float_cmp)]
#[no_mangle]
pub extern "C" fn unc_vm_f64_nearest(x: f64) -> f64 {
    // Rust doesn't have a nearest function, so do it manually.
    if x == 0.0 {
        // Preserve the sign of zero.
        x
...
#[no_mangle]
pub unsafe extern "C" fn unc_vm_memory32_grow(
    vmctx: *mut VMContext,
    delta: u32,
    memory_index: u32,
) -> u32 {
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_imported_memory32_grow(
    vmctx: *mut VMContext,
    delta: u32,
    memory_index: u32,
) -> u32 {
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_memory32_size(vmctx: *mut VMContext, memory_index: u32) -> u32 {
    let instance = (&*vmctx).instance();
    let memory_index = LocalMemoryIndex::from_u32(memory_index);
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_imported_memory32_size(
    vmctx: *mut VMContext,
    memory_index: u32,
) -> u32 {
    let instance = (&*vmctx).instance();
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_table_copy(
    vmctx: *mut VMContext,
    dst_table_index: u32,
    src_table_index: u32,
    dst: u32,
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_table_init(
    vmctx: *mut VMContext,
    table_index: u32,
    elem_index: u32,
    dst: u32,
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_table_fill(
    vmctx: *mut VMContext,
    table_index: u32,
    start_idx: u32,
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_table_size(vmctx: *mut VMContext, table_index: u32) -> u32 {
    let instance = (&*vmctx).instance();
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_imported_table_size(
    vmctx: *mut VMContext,
    table_index: u32,
) -> u32 {
    let instance = (&*vmctx).instance();
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_table_get(
    vmctx: *mut VMContext,
    table_index: u32,
    elem_index: u32,
) -> RawTableElement {
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_imported_table_get(
    vmctx: *mut VMContext,
    table_index: u32,
    elem_index: u32,
) -> RawTableElement {
...
#[no_mangle]
pub unsafe extern "C" fn unc_vm_table_set(
    vmctx: *mut VMContext,
    table_index: u32,
    elem_index: u32,
    ...
    if let Ok(local_table) = instance.artifact.import_counts().local_table_index(table_index) {
        ...
        panic!("unc_vm_imported_table_set should have been called");
    }
}
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_imported_table_set(
    vmctx: *mut VMContext,
    table_index: u32,
    elem_index: u32,
    value: RawTableElement,
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_table_grow(
    vmctx: *mut VMContext,
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_imported_table_grow(
    vmctx: *mut VMContext,
    init_value: RawTableElement,
    delta: u32,
    table_index: u32,
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_func_ref(vmctx: *mut VMContext, function_index: u32) -> VMFuncRef {
    let instance = (&*vmctx).instance();
...
#[no_mangle]
pub unsafe extern "C" fn unc_vm_externref_inc(externref: VMExternRef) {
    externref.ref_clone();
}
...
#[no_mangle]
pub unsafe extern "C" fn unc_vm_externref_dec(mut externref: VMExternRef) {
    externref.ref_drop()
}
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_elem_drop(vmctx: *mut VMContext, elem_index: u32) {
    let elem_index = ElemIndex::from_u32(elem_index);
    let instance = (&*vmctx).instance();
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_memory32_copy(
    vmctx: *mut VMContext,
    memory_index: u32,
    dst: u32,
    src: u32,
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_imported_memory32_copy(
    vmctx: *mut VMContext,
    memory_index: u32,
    dst: u32,
    src: u32,
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_memory32_fill(
    vmctx: *mut VMContext,
    memory_index: u32,
    dst: u32,
    val: u32,
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_imported_memory32_fill(
    vmctx: *mut VMContext,
    memory_index: u32,
    dst: u32,
    val: u32,
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_memory32_init(
    vmctx: *mut VMContext,
    memory_index: u32,
    data_index: u32,
    dst: u32,
...
/// `vmctx` must be dereferenceable.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_data_drop(vmctx: *mut VMContext, data_index: u32) {
    let data_index = DataIndex::from_u32(data_index);
    let instance = (&*vmctx).instance();
...
/// # Safety
///
/// Only safe to call when wasm code is on the stack, aka `unc_vm_call` or
/// `unc_vm_call_trampoline` must have been previously called.
#[no_mangle]
pub unsafe extern "C" fn unc_vm_raise_trap(trap_code: TrapCode) -> ! {
...
#[no_mangle]
pub static unc_vm_probestack: unsafe extern "C" fn() = PROBESTACK;
...
impl LibCall {
    ...
    pub fn function_pointer(self) -> usize {
        match self {
            Self::CeilF32 => unc_vm_f32_ceil as usize,
            Self::CeilF64 => unc_vm_f64_ceil as usize,
            Self::FloorF32 => unc_vm_f32_floor as usize,
            Self::FloorF64 => unc_vm_f64_floor as usize,
            Self::NearestF32 => unc_vm_f32_nearest as usize,
            Self::NearestF64 => unc_vm_f64_nearest as usize,
            Self::TruncF32 => unc_vm_f32_trunc as usize,
            Self::TruncF64 => unc_vm_f64_trunc as usize,
            Self::Memory32Size => unc_vm_memory32_size as usize,
            Self::ImportedMemory32Size => unc_vm_imported_memory32_size as usize,
            Self::TableCopy => unc_vm_table_copy as usize,
            Self::TableInit => unc_vm_table_init as usize,
            Self::TableFill => unc_vm_table_fill as usize,
            Self::TableSize => unc_vm_table_size as usize,
            Self::ImportedTableSize => unc_vm_imported_table_size as usize,
            Self::TableGet => unc_vm_table_get as usize,
            Self::ImportedTableGet => unc_vm_imported_table_get as usize,
            Self::TableSet => unc_vm_table_set as usize,
            Self::ImportedTableSet => unc_vm_imported_table_set as usize,
            Self::TableGrow => unc_vm_table_grow as usize,
            Self::ImportedTableGrow => unc_vm_imported_table_grow as usize,
            Self::FuncRef => unc_vm_func_ref as usize,
            Self::ElemDrop => unc_vm_elem_drop as usize,
            Self::Memory32Copy => unc_vm_memory32_copy as usize,
            Self::ImportedMemory32Copy => unc_vm_imported_memory32_copy as usize,
            Self::Memory32Fill => unc_vm_memory32_fill as usize,
            Self::ImportedMemory32Fill => unc_vm_memory32_fill as usize,
            Self::Memory32Init => unc_vm_memory32_init as usize,
            Self::DataDrop => unc_vm_data_drop as usize,
            Self::Probestack => unc_vm_probestack as usize,
            Self::RaiseTrap => unc_vm_raise_trap as usize,
        }
    }
    ...
    pub fn to_function_name(&self) -> &str {
        match self {
            Self::CeilF32 => "unc_vm_f32_ceil",
            Self::CeilF64 => "unc_vm_f64_ceil",
            Self::FloorF32 => "unc_vm_f32_floor",
            Self::FloorF64 => "unc_vm_f64_floor",
            Self::NearestF32 => "unc_vm_f32_nearest",
            Self::NearestF64 => "unc_vm_f64_nearest",
            Self::TruncF32 => "unc_vm_f32_trunc",
            Self::TruncF64 => "unc_vm_f64_trunc",
            Self::Memory32Size => "unc_vm_memory32_size",
            Self::ImportedMemory32Size => "unc_vm_imported_memory32_size",
            Self::TableCopy => "unc_vm_table_copy",
            Self::TableInit => "unc_vm_table_init",
            Self::TableFill => "unc_vm_table_fill",
            Self::TableSize => "unc_vm_table_size",
            Self::ImportedTableSize => "unc_vm_imported_table_size",
            Self::TableGet => "unc_vm_table_get",
            Self::ImportedTableGet => "unc_vm_imported_table_get",
            Self::TableSet => "unc_vm_table_set",
            Self::ImportedTableSet => "unc_vm_imported_table_set",
            Self::TableGrow => "unc_vm_table_grow",
            Self::ImportedTableGrow => "unc_vm_imported_table_grow",
            Self::FuncRef => "unc_vm_func_ref",
            Self::ElemDrop => "unc_vm_elem_drop",
            Self::Memory32Copy => "unc_vm_memory32_copy",
            Self::ImportedMemory32Copy => "unc_vm_imported_memory32_copy",
            Self::Memory32Fill => "unc_vm_memory32_fill",
            Self::ImportedMemory32Fill => "unc_vm_imported_memory32_fill",
            Self::Memory32Init => "unc_vm_memory32_init",
            Self::DataDrop => "unc_vm_data_drop",
            Self::RaiseTrap => "unc_vm_raise_trap",
            ...
            Self::Probestack => "_unc_vm_probestack",
            #[cfg(not(target_vendor = "apple"))]
            Self::Probestack => "unc_vm_probestack",
        }
    }
}
