...
use unc_vm_types::entity::{BoxedSlice, PrimaryMap};
use unc_vm_types::{FunctionIndex, GlobalIndex, MemoryIndex, TableIndex};
...
pub enum VMImportType {
    ...
    /// A global.
    Global(unc_vm_types::GlobalType),
    /// A table.
    Table(unc_vm_types::TableType),
    /// Some memory.
    Memory(unc_vm_types::MemoryType, crate::MemoryStyle),
}
