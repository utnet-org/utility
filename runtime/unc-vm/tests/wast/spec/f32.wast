...
(module
  ...
  (func (export "uncest") (param $x f32) (result f32) (f32.uncest (local.get $x)))
)
...
(assert_return (invoke "trunc" (f32.const nan)) (f32.const nan:canonical))
(assert_return (invoke "trunc" (f32.const nan:0x200000)) (f32.const nan:arithmetic))
(assert_return (invoke "uncest" (f32.const -0x0p+0)) (f32.const -0x0p+0))
(assert_return (invoke "uncest" (f32.const 0x0p+0)) (f32.const 0x0p+0))
(assert_return (invoke "uncest" (f32.const -0x1p-149)) (f32.const -0x0p+0))
(assert_return (invoke "uncest" (f32.const 0x1p-149)) (f32.const 0x0p+0))
(assert_return (invoke "uncest" (f32.const -0x1p-126)) (f32.const -0x0p+0))
(assert_return (invoke "uncest" (f32.const 0x1p-126)) (f32.const 0x0p+0))
(assert_return (invoke "uncest" (f32.const -0x1p-1)) (f32.const -0x0p+0))
(assert_return (invoke "uncest" (f32.const 0x1p-1)) (f32.const 0x0p+0))
(assert_return (invoke "uncest" (f32.const -0x1p+0)) (f32.const -0x1p+0))
(assert_return (invoke "uncest" (f32.const 0x1p+0)) (f32.const 0x1p+0))
(assert_return (invoke "uncest" (f32.const -0x1.921fb6p+2)) (f32.const -0x1.8p+2))
(assert_return (invoke "uncest" (f32.const 0x1.921fb6p+2)) (f32.const 0x1.8p+2))
(assert_return (invoke "uncest" (f32.const -0x1.fffffep+127)) (f32.const -0x1.fffffep+127))
(assert_return (invoke "uncest" (f32.const 0x1.fffffep+127)) (f32.const 0x1.fffffep+127))
(assert_return (invoke "uncest" (f32.const -inf)) (f32.const -inf))
(assert_return (invoke "uncest" (f32.const inf)) (f32.const inf))
(assert_return (invoke "uncest" (f32.const -nan)) (f32.const nan:canonical))
(assert_return (invoke "uncest" (f32.const -nan:0x200000)) (f32.const nan:arithmetic))
(assert_return (invoke "uncest" (f32.const nan)) (f32.const nan:canonical))
(assert_return (invoke "uncest" (f32.const nan:0x200000)) (f32.const nan:arithmetic))
...
(assert_invalid (module (func (result f32) (f32.uncest (i64.const 0)))) "type mismatch")
