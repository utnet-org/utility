...
(module
  ...
  (func (export "uncest") (param $x f64) (result f64) (f64.uncest (local.get $x)))
)
...
(assert_return (invoke "trunc" (f64.const nan)) (f64.const nan:canonical))
(assert_return (invoke "trunc" (f64.const nan:0x4000000000000)) (f64.const nan:arithmetic))
(assert_return (invoke "uncest" (f64.const -0x0p+0)) (f64.const -0x0p+0))
(assert_return (invoke "uncest" (f64.const 0x0p+0)) (f64.const 0x0p+0))
(assert_return (invoke "uncest" (f64.const -0x0.0000000000001p-1022)) (f64.const -0x0p+0))
(assert_return (invoke "uncest" (f64.const 0x0.0000000000001p-1022)) (f64.const 0x0p+0))
(assert_return (invoke "uncest" (f64.const -0x1p-1022)) (f64.const -0x0p+0))
(assert_return (invoke "uncest" (f64.const 0x1p-1022)) (f64.const 0x0p+0))
(assert_return (invoke "uncest" (f64.const -0x1p-1)) (f64.const -0x0p+0))
(assert_return (invoke "uncest" (f64.const 0x1p-1)) (f64.const 0x0p+0))
(assert_return (invoke "uncest" (f64.const -0x1p+0)) (f64.const -0x1p+0))
(assert_return (invoke "uncest" (f64.const 0x1p+0)) (f64.const 0x1p+0))
(assert_return (invoke "uncest" (f64.const -0x1.921fb54442d18p+2)) (f64.const -0x1.8p+2))
(assert_return (invoke "uncest" (f64.const 0x1.921fb54442d18p+2)) (f64.const 0x1.8p+2))
(assert_return (invoke "uncest" (f64.const -0x1.fffffffffffffp+1023)) (f64.const -0x1.fffffffffffffp+1023))
(assert_return (invoke "uncest" (f64.const 0x1.fffffffffffffp+1023)) (f64.const 0x1.fffffffffffffp+1023))
(assert_return (invoke "uncest" (f64.const -inf)) (f64.const -inf))
(assert_return (invoke "uncest" (f64.const inf)) (f64.const inf))
(assert_return (invoke "uncest" (f64.const -nan)) (f64.const nan:canonical))
(assert_return (invoke "uncest" (f64.const -nan:0x4000000000000)) (f64.const nan:arithmetic))
(assert_return (invoke "uncest" (f64.const nan)) (f64.const nan:canonical))
(assert_return (invoke "uncest" (f64.const nan:0x4000000000000)) (f64.const nan:arithmetic))
...
(assert_invalid (module (func (result f64) (f64.uncest (i64.const 0)))) "type mismatch")
