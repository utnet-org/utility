...
(module
  ...
  (func (export "nan-canonicalization-f32-uncest") (param i32) (result i32)
    (i32.reinterpret_f32 (f32.uncest (f32.reinterpret_i32 (local.get 0))))
  )
  ...
  (func (export "nan-canonicalization-f32-local") (param i32) (result i32)
    (local f32)
    (set_local 1 (f32.reinterpret_i32 (local.get 0)))
    (i32.reinterpret_f32 (local.get 1))
  )
  (func (export "nan-canonicalization-f32-local-cncl") (param i32) (result i32)
    (local f32)
    (set_local 1 (f32.add (f32.reinterpret_i32 (local.get 0)) (f32.const 0)))
    (i32.reinterpret_f32 (local.get 1))
  )
  ...
  (func (export "nan-canonicalization-f64-uncest") (param i64) (result i64)
    (i64.reinterpret_f64 (f64.uncest (f64.reinterpret_i64 (local.get 0))))
  )
  ...
  (func (export "nan-canonicalization-f64-local") (param i64) (result i64)
    (local f64)
    (set_local 1 (f64.reinterpret_i64 (local.get 0)))
    (i64.reinterpret_f64 (local.get 1))
  )
  (func (export "nan-canonicalization-f64-local-cncl") (param i64) (result i64)
    (local f64)
    (set_local 1 (f64.add (f64.reinterpret_i64 (local.get 0)) (f64.const 0)))
    (i64.reinterpret_f64 (local.get 1))
  )
...
(assert_return (invoke "nan-canonicalization-f32-uncest" (i32.const 0x7fc00001)) (i32.const 0x7fc00000))
...
(assert_return (invoke "nan-canonicalization-f64-uncest" (i64.const 0x7ff8000000000001)) (i64.const 0x7ff8000000000000))
