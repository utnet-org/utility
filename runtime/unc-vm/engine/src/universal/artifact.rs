...
pub struct UniversalArtifact {
    ...
    pub(crate) exports: BTreeMap<String, unc_vm_types::ExportIndex>,
...
impl Instantiatable for UniversalArtifact {
    ...
    unsafe fn instantiate(
        ...
        config: unc_vm_types::InstanceConfig,
        ...
        let (allocator, memory_definition_locations, table_definition_locations) =
            unc_vm_vm::InstanceAllocator::new(self.vmoffsets.clone());

        // Memories
        let mut memories: PrimaryMap<unc_vm_types::LocalMemoryIndex, _> =
        ...
        // Tables
        let mut tables: PrimaryMap<unc_vm_types::LocalTableIndex, _> =
        ...
        for (ty, _) in self.local_globals.iter() {
            globals.push(Arc::new(unc_vm_vm::Global::new(*ty)));
        }
...
impl Artifact for UniversalArtifact {
    fn offsets(&self) -> &unc_vm_vm::VMOffsets {
        &self.vmoffsets
    }
    ...
    fn export_field(&self, name: &str) -> Option<unc_vm_types::ExportIndex> {
        self.exports.get(name).cloned()
    }

    fn signatures(&self) -> &[unc_vm_vm::VMSharedSignatureIndex] {
