...
pub(crate) struct FuncGen<'a> {
    ...
    local_types: unc_vm_types::partial_sum_map::PartialSumMap<u32, WpType>,
...
impl<'a> FuncGen<'a> {
    ...
    pub(crate) fn new(
        ...
        let mut fg = FuncGen {
            ...
            target,
            vmoffsets,
            local_types: unc_vm_types::partial_sum_map::PartialSumMap::new(),
            assembler,
            value_stack: vec![],
            fp_stack: vec![],
            control_stack: vec![],
    ...
    #[tracing::instrument(target = "unc_vm", level = "trace", skip(self))]
...
#[tracing::instrument(target = "unc_vm", level = "trace")]
...
#[tracing::instrument(target = "unc_vm", level = "trace", skip(vmoffsets))]
