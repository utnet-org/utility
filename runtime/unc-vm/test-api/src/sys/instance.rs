...
impl From<unc_vm_engine::InstantiationError> for InstantiationError {
    fn from(other: unc_vm_engine::InstantiationError) -> Self {
        match other {
            unc_vm_engine::InstantiationError::Link(e) => Self::Link(e),
            unc_vm_engine::InstantiationError::Start(e) => Self::Start(e),
            unc_vm_engine::InstantiationError::CpuFeature(e) => Self::CpuFeature(e),
        }
    }
}
...
impl Instance {
    ...
    ///
    /// ```
    /// # use unc_vm_test_api::{imports, Store, Module, Global, Value, Instance, InstanceConfig};
    ...
    pub fn new_with_config(
        ...
        // parameter.
        unsafe {
            unc_vm_vm::initialize_host_envs::<HostEnvInitError>(
                &*instance.handle,
