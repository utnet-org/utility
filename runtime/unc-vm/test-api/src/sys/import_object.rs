...
//! functions.
use unc_vm_vm::{Export, NamedResolver};
...
/// # Usage:
/// ```ignore
/// use unc_vm_test_api::{Exports, ImportObject, Function};
///
...
impl ImportObject {
    ...
    /// # Usage
    /// ```ignore
    /// # use unc_vm_vm::{ImportObject, Instance, Namespace};
    /// let mut import_object = ImportObject::new();
...
///
/// ```
/// # use unc_vm_test_api::{Function, Store};
/// # let store = Store::default();
/// use unc_vm_test_api::imports;
///
...
mod test {
    ...
    use unc_vm_vm::ChainableNamedResolver;
