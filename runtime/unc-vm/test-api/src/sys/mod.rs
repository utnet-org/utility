...
pub use unc_vm_types::ExternRef;
pub use unc_vm_vm::{Export, NamedResolver};

#[cfg(feature = "wat")]
pub use wat::parse_bytes as wat2wasm;

#[cfg(feature = "singlepass")]
pub use unc_vm_compiler_singlepass::Singlepass;

#[cfg(feature = "universal")]
pub use unc_vm_engine::universal::{Universal, UniversalArtifact, UniversalEngine};
