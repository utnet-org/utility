...
use unc_chain_configs::{DumpConfig, ExternalStorageConfig, Genesis, SyncConfig};
use unc_client::adapter::{StateRequestHeader, StateRequestPart, StateResponse};
...
use unc_primitives::state_sync::{CachedParts, StatePartKey};
use unc_primitives::transaction::SignedTransaction;
use unc_primitives::types::{BlockId, BlockReference, EpochId, EpochReference};
...
fn sync_state_nodes() {
    heavy_test(|| {
        ...
        run_actix(async move {
            ...
            let unc_infra::UncNode { view_client: view_client1, .. } =
