...
pub static PARTIAL_ENCODED_CHUNK_REQUEST_PROCESSING_TIME: Lazy<unc_o11y::metrics::HistogramVec> =
    Lazy::new(|| {
        unc_o11y::metrics::try_create_histogram_vec(
            "unc_partial_encoded_chunk_request_processing_time",
            concat!(
...
pub(crate) static PARTIAL_ENCODED_CHUNK_RESPONSE_DELAY: Lazy<Histogram> = Lazy::new(|| {
    try_create_histogram(
            "unc_partial_encoded_chunk_response_delay",
...
pub static PARTIAL_ENCODED_CHUNK_FORWARD_CACHED_WITHOUT_HEADER: Lazy<Counter> = Lazy::new(|| {
    unc_o11y::metrics::try_create_counter(
        "unc_partial_encoded_chunk_forward_cached_without_header",
        concat!(
...
pub static PARTIAL_ENCODED_CHUNK_FORWARD_CACHED_WITHOUT_PREV_BLOCK: Lazy<Counter> = Lazy::new(
    || {
        unc_o11y::metrics::try_create_counter(
        "unc_partial_encoded_chunk_forward_cached_without_prev_block",
        concat!(
